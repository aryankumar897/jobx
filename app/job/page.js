...
export default function job({ searchParams }) {
    ...
    const fetchdata = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.API}/job/${slug}`)
    ...
    const handlejob = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.API}/jobapply`, {
    ...
    const fetchjobapply = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.API}/jobapplycheck/${slug}`)
