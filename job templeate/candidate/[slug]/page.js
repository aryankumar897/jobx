...
const dummyCandidate = {
    image: { secure_url: '/image/dee.jpg' },
    full_name: 'John Doe',
    title: 'Software Engineer',
    bio: 'Experienced Software Engineer with a demonstrated history of working in the information technology and services industry.',
    country: { name: 'USA' },
    experience_lable: 'Mid-Level',
    profession_id: [{ name: 'Engineering' }],
...
const dummyExperience = [
    {
        ...
        responsibilities: 'Developed and maintained web applications. Collaborated with cross-functional teams.',
        start: '2018-01-01',
        end: '2020-12-31',
    ...
    },
    {
        ...
        responsibilities: 'Led a team of developers. Improved application performance.',
        start: '2021-01-01',
...
const dummyEducation = [
    {
        ...
        level: 'Undergraduate',
        year: '2014-01-01',
        notes: 'Graduated with honors. Specialized in software development.'
    }
];
...
const dummySkills = [
    {
        _id: '1',
        skill_id: [{ _id: '1', name: 'JavaScript' }, { _id: '2', name: 'React' }]
    }
];
...
const dummyLanguages = [
    {
        _id: '1',
        lang_id: [{ _id: '1', name: 'English' }, { _id: '2', name: 'Spanish' }]
    }
];
...
export default async function ProductViewPage({ params }) {
    ...
    const candidate = dummyCandidate;
    const experience = dummyExperience;
    const education = dummyEducation;
    const candidateskill = dummySkills;
    const candidateLanguage = dummyLanguages;
